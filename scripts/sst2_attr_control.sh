...
# positive
control_gen "The food at the restaurant was" "gpt2-xl-ctrl_sst2_pos-pool_max" 1

# negative
control_gen "The food at the restaurant was" "gpt2-xl-ctrl_sst2_neg-pool_max" 0